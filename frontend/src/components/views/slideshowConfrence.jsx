...
const items = [
    {
        ...
        description: "We are here to let you in on a little secret, a change in mindset that will not only help make your business more profitable but will...",
    ...
    },
    {
        ...
        description: "Whether you are an entrepreneur trying to grow your business, a CEO looking to take your company to the next level or a leader…",
        picture: "https://s3-alpha-sig.figma.com/img/45d0/e5c0/791de6c34bc5752018469b42e83244e1?Expires=1729468800&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=WDY70tID41vSWx4mV7U~7brE6eARAwty9s0Y4vtw7-udCymFT3epKrcV1UDNUUoNHN505Zvu0U307EPHZp5bA-oDImDRt-PO5PQ2O96H8PfkOEASTNoH3rGbibzb6bVhtM3Wq1oCAJkXGQWIIFXdTxjeWQ67T9VVx7PSM1iZnxdFAj2wfhqxsvXk9SGRqIpkcgNi0yvQa7SgXm0egB6xuxvmT~PYN9cU~I0k2aZlA1xOPN-lOiqnm0T9L9cx1wOZ4~V2Ou2Q1OpjikhR9A4GSYST2M6qa0MfJRM5D9vLW6bnsFhX4zQxbBejzaen9wpDYkQvu-f5AeofGzkr3v413A__"
    },
    {
        name: "Awaken Your True Power at the 2024 She’s Unstoppable Summit",
        description: "It’s time for us, the women of the world, to awaken our true power and nature. In a world filled with noise, confusion, and division, we...",
        picture: "https://s3-alpha-sig.figma.com/img/0c5d/9299/2b56109fda3338fd3326224db6f9954d?Expires=1729468800&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=CqdTCGcjJgP2A6xqFL8AsmXyhQ2wkc4IFyv3XpDMpZuOHENhDPxsAXsnWKhFm1b3xbqBjIYZ17J3yMi07Vz5rSC2DVXUCHwPozk28DSRVvC~T9JFPsnVGFgJZZeI~izqKOyjIryGaUiDfJIeKltSCrvyzAQ9k1~3DNPXGg4bLeI1PdSfFlu3z66Phs4MH4Iw7LeWDRUnL1XIJPMKGOie6Fn9vKy~gThD3aSFYvv49gl6i-x6Eyq4S41IpYp9VR3G2lRBh9V8K1qZyfabyJJ5oV6cXPO1dj7~J4A8JsuHEczN1sAnlzzv4eIf7Q260l676ORlRXTOUQQi5jObYx4zWw__"
    },
    {
        name: "How to Build an Engaging Team Culture",
        description: "Learn the keys to creating a workplace culture that boosts productivity, creativity, and employee satisfaction…",
        picture: "https://engagedly.com/wp-content/uploads/2016/08/increase_employee_engagement.jpg"
    },
    {
        name: "The Power of Personal Branding for Entrepreneurs",
        description: "Your personal brand is a vital asset in today's digital landscape. Learn how to create a brand that resonates and builds lasting connections...",
        picture: "https://theboldbusinessexpert.com/wp-content/uploads/2022/06/personal-branding-i-am-a-brand-t-shirt-image.jpg"
    },
    {
        name: "Maximizing Efficiency with Lean Management",
        description: "Discover how lean management principles can streamline operations, reduce waste, and drive performance in any industry...",
        picture: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQm9Np3tnnCsufv2gqykYYhqgG4llXb3wWtFQ&s"
    },
    {
        name: "How to Scale Your Business Sustainably",
        description: "Scaling a business isn't just about growth; it's about doing it in a way that ensures long-term success and stability…",
        picture: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT-uN-SzGZ8YrcxQcQAX_YJVhL5hOqhzWVGpA&s"
    },
    {
        name: "Navigating Market Disruption in 2024",
        description: "With rapid changes in technology and consumer behavior, navigating market disruption requires agility and innovation…",
        picture: "https://www.investopedia.com/thmb/tgiKtPxCCWmrWjoatbGb2MBki0M=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/stock-market-169975453-0435fcd8012e49c898d8dbf377a27826.jpg"
    },
    {
        name: "Leveraging AI to Grow Your Business",
        description: "Artificial Intelligence is reshaping industries. Learn how to leverage AI in marketing, operations, and customer service to gain a competitive edge...",
        picture: "https://media.istockphoto.com/id/1418476287/photo/businessman-analyzing-companys-financial-balance-sheet-working-with-digital-augmented-reality.jpg?s=612x612&w=0&k=20&c=Cgdq4iCELzmCVg19Z69GPt0dgNYbN7zbAARkzNSpyno="
    }
];
...
export default function CustomCarousel() {
    ...
    const calculateTranslateX = (index) => {
        const translateX = index * (containerWidth * (itemWidthPercentage / 100 + gapPercentage / 100));
        return translateX;
    };
