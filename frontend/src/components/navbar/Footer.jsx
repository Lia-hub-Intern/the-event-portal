        ...
        <Box
          sx={{
            ...
            "&::before": {
              ...
              height: "100%",
              backgroundImage:
                "url(https://img.freepik.com/foto-gratis/empresario-corporativo-dando-presentacion-gran-audiencia_53876-101865.jpg?t=st=1729297332~exp=1729300932~hmac=4d7bbc1ead338883728444905027613c666a977b5d7590e66d92579f4f41e6b0&w=996)",
              /*backgroundImage:
                "url(https://murf.ai/resources/media/posts/199/responsive/corporate-businessman-giving-presentation-large-audience-sm.jpg)",*/
          ...
          >
            ...
            >
              ...
              <Typography variant="body1" sx={{ fontSize: "1.1em" }}>
                Get exclusive updates on speakers, workshops, and more by
                subscribing today. Don’t miss out – join us now!
              </Typography>
            ...
            >
              ...
              <Box sx={{ flex: 1, minWidth: "200px", mb: 2 }}>
                ...
                <Typography variant="body2" sx={{ lineHeight: 1.6 }}>
                  We teach speakers how to consistently get booked and paid to
                  speak. We’ve helped thousands of speakers find clarity,
                  confidence, and a clear path to make an impact.
                </Typography>
              </Box>
