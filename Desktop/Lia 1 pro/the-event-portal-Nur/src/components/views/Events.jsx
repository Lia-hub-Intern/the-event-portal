/**
 * Developer Full Stack: Darwin Rengifo / Alexandra / Nurhussein
 *
 ...
 * - Display Calander to the cammining Events 
 *
 */
...
// New imports for calendar functionality
...
export default function Events({ title }) {
  ...
  return (
    <>
      ...
      {/* Calendar component By Nurhussein */}
      ...
      <style jsx>{`
        ...
        .calendar-container .events select {
          width: 100%;
          padding: 10px;
          margin-bottom: 20px;
        ...
        .calendar-container .events select:focus {
          outline: none;
          border-color: var(--primary-color);
          box-shadow: 0 0 0 2px rgba(52, 152, 219, 0.2);
        }
        
        .calendar-container .events ul {
          list-style-type: none;
          padding: 0;
        }
        
        .calendar-container .events li {
          padding: 15px;
          border-bottom: 1px solid var(--border-color);
          transition: all 0.3s ease;
        }
        
        .calendar-container .events li:last-child {
          border-bottom: none;
        }
        
        .calendar-container .events li:hover {
          background-color: #f8f9fa;
        }
        
        .calendar-container .events li strong {
          color: var(--primary-color);
          font-size: 1.1rem;
        }
        
        .calendar-container .events li a {
        ...
        .calendar-container .events li a:hover {
